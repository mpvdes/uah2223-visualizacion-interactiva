...
String bikeFile = "licenciasNulas.csv";// in case URL goes down
...
String[] a_distritos = {"Ciutat Vella", "Sants-Montjuïc", "Les Corts", "Nou Barris", "Sant Andreu", "Sant Martí", "Eixample", "Gràcia", "Horta-Guinardó", "Sarrià-Sant Gervasi"};
